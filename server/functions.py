        ...
        for i in range(len(statevector)):
            ...
            if statevector[i].real != 0:
                if diracNotation != "":
                    if statevector[i].real > 0:
                        string = "{0:.4f}".format(
                            statevector[i].real).replace('.0000', '')
                        string = "" if abs(float(string)) == 1 else string
                        diracNotation += "+ "+string
                    else:
                        string = "{0:.4f}".format(
                            statevector[i].real*-1).replace('.0000', '')
                        string = "" if abs(float(string)) == 1 else string
                        diracNotation += "- "+string
                else:
                    string = "{0:.4f}".format(
                ...
                if statevector[i].imag != 0:
                    if statevector[i].imag > 0:
                        string = "{0:.4f}".format(
                            statevector[i].imag).replace('.0000', '')
                        string = "" if abs(float(string)) == 1 else string
                        diracNotation += "+ "+string+"i"
                    else:
                        string = "{0:.4f}".format(
                            statevector[i].imag*-1).replace('.0000', '')
                        string = "" if abs(float(string)) == 1 else string
                        diracNotation += "- "+string + " i"
            ...
            diracNotation += " |" + \
                str(("{0:0"+str(circuit.n_qubits).replace('.0000', '')+"b}").format(i))+"⟩ "
        ...
        for i in range(len(unitary)):
            ...
            for j in range(len(unitary[i])):
                ...
                if unitary[i][j].real != 0:
                    matrix[i].append(str("{0:.4f}".format(
                        unitary[i][j].real)).replace('.0000', ''))
                    if unitary[i][j].imag != 0:
                        matrix[i][j] += "+" + \
                            str("{0:.4f}".format(unitary[i][j].imag).replace(
                                '.0000', ''))+" i"
                elif unitary[i][j].imag != 0:
                    matrix[i].append(str("{0:.4f}".format(
                        unitary[i][j].imag)+" i").replace('.0000', ''))
